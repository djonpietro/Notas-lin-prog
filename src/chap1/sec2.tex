...
Para facilitar a notação, podemos usar a representação matricial para o conjunto de
...
A forma canônica de um PPL depende do tipo de otimização que estamos buscando.
